    ...
    <section className='flex flex-col sm:bg-marromedio w-full h-screen sm:flex-row'>
        ...
        <div className='flex items-center bg-marromedio w-full h-screen justify-center sm:bg-marromedio sm:w-1/2 sm:h-screen'>
          <article className='mb-5 mt-5'>
            ...
            <p className='text-center text-bege m-10'>A Doce Aroma é uma cafeteria que tem por objetivo ser um ambiente aconchegante unindo duas experiências: desfrutar de um delicioso café lendo um incrível livro.</p>
            <p className='text-center text-bege m-10'>Pensando nisso, trouxemos um ambiente ideal para você ler seu livro favorito, com jazz de fundo e uma boa dose de café acompanhada da comida de sua preferência.</p>
          </article>
        </div>
